...
$( document ).ready(function() {
	...
	if( $('#chart_1').length > 0 ){
		...
		var data1 = {
			...
			{
				label: "fir",
				backgroundColor: "#5c6d9f",
				borderColor: "#5c6d9f",
				pointBorderColor: "#5c6d9f",
				pointHighlightStroke: "#5c6d9f",
			...
			datasets: [
				{
					...
					backgroundColor: "#5c6d9f",
					borderColor: "#5c6d9f",
					pointBackgroundColor: "#5c6d9f",
					pointBorderColor: "#fff",
					pointHoverBackgroundColor: "#fff",
					pointHoverBorderColor: "#5c6d9f",

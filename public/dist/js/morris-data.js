...
$(function() {
    ...
    if($('#morris_area_chart').length > 0)
		...
		Morris.Area({
			...
			lineWidth:0,
			fillOpacity: 1,
			pointStrokeColors:['#4267b2', '#5c6d9f', '#a6afd9'],
			behaveLikeLine: true,
			grid: false,
			hideHover: 'auto',
			lineColors: ['#4267b2', '#5c6d9f', '#a6afd9'],
			resize: true,
			redraw: true,
			smooth: true,
	...
	if($('#morris_extra_bar_chart').length > 0)
		...
		Morris.Bar({
			...
			ykeys: ['a', 'b', 'c'],
			labels: ['A', 'B', 'C'],
			barColors:['#4267b2', '#5c6d9f', '#a6afd9'],
			barOpacity:1,
			hideHover: 'auto',
			grid: false,
			resize: true,

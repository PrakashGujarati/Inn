    ...
    <div class="container" style="min-height: 550px;margin-top:20px;">
        <div class="row heading-bg">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h5 class="txt-dark">Identity Master</h5>
            </div>
            <!-- Breadcrumb -->
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="/identity/"><span>Identity Master</span></a></li>
                </ol>
            </div>
            <!-- /Breadcrumb -->
        </div>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default border-panel card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Identity Master</h6>
                        </div>
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="table-wrap">
                                @include('Masters.Identity._form')
    ...
    <script>
        ...
        $(document).ready(function (e) {
            mytable = $('.dynamic-table').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "{{ url('/identity/getDataTable') }}",
                columns: [
                    {data: "name"},
                    {data: "sname"},
                    {data: "edit"},
             ...
             $(document).on('click', '.edit', function () {
                ...
                $('#editform #sname').val(sname);
                $('#editform').attr('action', '/identity/' + id);

    ...
    <div class="container" style="min-height: 550px;margin-top:20px;">
        <div class="row heading-bg">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h5 class="txt-dark">Room Number</h5>
            </div>
            <!-- Breadcrumb -->
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="/rooms/create"><span>Room Number</span></a></li>
                </ol>
            </div>
            <!-- /Breadcrumb -->
        </div>
            ...
            <div class="col-sm-12">
                <div class="panel panel-default border-panel card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Room Number</h6>
                        </div>
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                {!! Form::model($rooms,["method"=>"post",'action' =>  ['RoomController@update',$rooms->id],"id" =>"rooms","class" => "form-inline","files" => "true"]) !!}
                    ...
                    "dataSrc": function (json) {
                        ...
                        for(var i=0;i< json.length; i++){
                            return_data.push({
                                ...
                                'action': '<a class="btn btn-sm btn-primary ti-pencil" style="padding:10px;margin-right:5px;" href="/rooms/'+json[i].id+'/edit"></a>'+

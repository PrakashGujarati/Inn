                ...
                <div class="panel panel-default border-panel card-view">
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                {!! Form::model($roomstatus,['method'=>'post','action' =>  ['RoomStatusController@update',$roomstatus->id], 'id' => 'roomstatus', 'class' => 'form-inline',"files" => "true"]) !!}
                                <input type="hidden" id="token" name="_token" value="{{ csrf_token() }}">

                                @include('RoomMaster.RoomStatus._form')

                                <a class="btn btn-orange  btn-anim pull-right ml-5" href="/roomstatus/create">Add</a>
    ...
    <script>
        $(document).ready(function (e) {
                    ...
                    "dataSrc": function (json) {
                        ...
                        for(var i=0;i< json.length; i++){
                            return_data.push({
                                ...
                                'color': json[i].color,
                                'action': '<a class="btn btn-sm btn-primary ti-pencil" style="padding:10px;margin-right:5px;" href="/roomstatus/'+json[i].id+'/edit"></a>'+
            ...
            $("#add").click(function () {
                ...
                var color = $("#color").val();
                var token = $("#token").val();
                var action = $("#roomstatus").attr('action');

            ...
            <div class="col-sm-12">
                <div class="panel panel-default border-panel card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark" style="margin-top: 3px;">View - Room Status</h6>
                        </div>
                        <a class="btn btn-primary btn-sm pull-right" href="/roomstatus/create">Add</a>
                                ...
                                <div class="table-responsive">
                                    <table id="datable_1" class="table table-hover display  pb-30" >
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$rs->status}}</td>
                                            <td>{{$rs->color}}</td>
                                            <td><a class="btn btn-primary fa fa-edit"  href="roomstatus/{{ $rs->id }}/edit" ></a></td>
                                        </tr>
                                        @endforeach
                                        </tbody>
                                    </table>

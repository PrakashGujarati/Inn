            ...
            <div class="col-sm-12">
                <div class="panel panel-default border-panel card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Room Types</h6>
                        </div>
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
                            <div class="form-wrap">
                                {!! Form::model($roomtypes,['method'=>'post','action' =>  ['RoomTypeController@update',$roomtypes->id],'class' => 'form-horizontal',"files" => "true"]) !!}
                                {{ csrf_field() }}
